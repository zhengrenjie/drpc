...
public class BrpcHttpProcessHandler extends SimpleChannelInboundHandler<FullHttpRequest> {

  private static final Logger LOGGER = LoggerFactory.getLogger(
      BrpcHttpProcessHandler.class);
  private BrpcIService service;

  public BrpcHttpProcessHandler(BrpcIService service) {
  ...
  protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) {
    ...
    // get
    BenchmarkProtocol.Response response = service.get(request);
