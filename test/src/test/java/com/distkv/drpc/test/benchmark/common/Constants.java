...
public class Constants {
  ...
  public static final String TEST_CONTENT = "hello";
//      "And in another Reddit thread, users on Sprint, T-Mobile, Verizon, and Xfinity Mobile have been reporting throughout the day that they have the update.\n"
//          + "\n"
