...
public class DubboBenchmarkGateway {

  private Logger logger = LoggerFactory.getLogger(DubboBenchmarkGateway.class);
  private EventLoopGroup bossGroup;
  private EventLoopGroup workerGroup;

  public void start(DubboIService service) {
    ServerBootstrap bootstrap = new ServerBootstrap();
    bossGroup = new NioEventLoopGroup(1);
    workerGroup = new NioEventLoopGroup(Runtime.getRuntime().availableProcessors() * 2);
    ChannelHandler handler = new DubboHttpProcessHandler(service);
